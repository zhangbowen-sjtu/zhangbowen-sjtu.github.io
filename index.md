...
* **Persistent Memory-based Systems.** Emergying persistent memory provides many attractive features, such as byte addressability, DRAM-comparable performance, and data durability,  which motivates us to redesign existing systems to fully harness the benefits of persistent memory.
